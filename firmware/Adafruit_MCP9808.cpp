...
Adafruit_MCP9808::Adafruit_MCP9808(uint8_t addr){
...
float Adafruit_MCP9808::getTemperature(){
...
void Adafruit_MCP9808::setPowerMode(uint16_t mode){
	Wire.beginTransmission(_i2cAddr);
...
void Adafruit_MCP9808::setResolution(uint8_t mode){
	Wire.beginTransmission(_i2cAddr);
